...
<style>
    .yearPlanPersonEdit .mint-field .mint-cell-title {
        color: #333;
    }
    .yearPlanPersonEdit input::-moz-placeholder {
        color: #bababa;
    }
    .yearPlanPersonEdit .subdivideVal .mint-cell-wrapper {
        background-position: bottom left;
    }
    .yearPlanPersonEdit .mint-cell-wrapper {
        background-position: bottom left;
    }
    .yearPlanPersonEdit .mint-cell:last-child {
        background-size: 93% 1px;
    }
    .yearPlanPersonEdit .subdivideVal .mint-cell-title {
        display: none;
    }
    .yearPlanPersonEdit .mint-cell:first-child .mint-cell-wrapper {
        background: none;
    }
    .yearPlanPersonEdit .mint-field .mint-field-core {
        text-align: left;
    }
    .yearPlanPersonEdit .mint-field.datePicker .mint-field-core {
        display: none;
    }
    .yearPlanPersonEdit .mint-popup-bottom {
        width: 100%;
    }
    .yearPlanPersonEdit .picker-slot:first-child {
        display: none;
    }
